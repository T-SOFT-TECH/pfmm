<script lang="ts">
	...
	const footerLinks = {
		...
		initiatives: [
			{ href: '/empowerment', label: 'Empowerment Programs' },
	...
	<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
			...
			<div>
				...
				<ul class="space-y-3">
					{#each footerLinks.quick as link}
						<li>
							<a
								href={link.href}
								class="text-dark-300 hover:text-primary-400 transition-colors text-sm"
							>
								{link.label}
							</a>
						</li>
			...
			<!-- Initiatives -->
			<div>
				<h3 class="text-lg font-semibold text-primary-400 mb-4">Initiatives</h3>
				<ul class="space-y-3">
					{#each footerLinks.initiatives as link}
						<li>
							<a
								href={link.href}
								class="text-dark-300 hover:text-primary-400 transition-colors text-sm"
		...
		<div class="mt-12 pt-8 border-t border-dark-800">
			<div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
				<p class="text-sm text-dark-400">
					© {currentYear} Aliu Ifeoluwa Philemon. All rights reserved.
				</p>
				<div class="flex space-x-6 text-sm">
					<a href="/privacy" class="text-dark-400 hover:text-primary-400 transition-colors">
						Privacy Policy
					</a>
					<a href="/terms" class="text-dark-400 hover:text-primary-400 transition-colors">
						Terms of Service
					</a>
				</div>
			</div>
