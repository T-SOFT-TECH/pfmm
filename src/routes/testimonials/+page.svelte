	...
	const testimonials = [
		{
			id: 1,
			name: 'Samuel Adebayo',
			role: 'Trainee, Jesutofunwa Foundation',
			content: 'Working with Ifeoluwa transformed how I understand sound and creativity. His teaching style makes technical learning easy and inspiring.',
			rating: 5,
			image: '/logo.png'
		},
		{
			...
			name: 'Grace Okonkwo',
			role: 'Music Artist',
			content: 'The production quality and creative direction I received was exceptional. Ifeoluwa brought my vision to life in ways I never imagined.',
			rating: 5,
			image: '/logo.png'
		},
		{
			...
			role: 'Christ Apostolic Church, Doncaster',
			content: 'The media installation and training provided have transformed our church\'s ability to reach and serve our community. Professional and thorough work.',
			rating: 5,
			image: '/logo.png'
		},
		{
			...
			content: 'The empowerment program gave me the skills and confidence to start my own media business. The mentorship continues to be invaluable.',
			rating: 5,
			image: '/logo.png'
		},
		{
			id: 5,
			name: 'Michael Oladipo',
			role: 'Event Organizer',
			content: 'Outstanding live sound engineering for our annual conference. Every detail was handled with professionalism and expertise.',
			rating: 5,
			image: '/logo.png'
		},
		{
			...
			content: 'The training opened doors I never knew existed. I\'m now working professionally in media production thanks to what I learned.',
			rating: 5,
			image: '/logo.png'
		}
	];
				...
				<Animate variant="slide-up" duration={0.6} delay={i * 0.1}>
					...
					<div class="flex items-center space-x-4 pt-4 border-t border-dark-700">
						...
						<div>
							...
							<div class="text-dark-500 text-sm">{testimonial.role}</div>
						</div>
					</div>
					</div>
				</Animate>
